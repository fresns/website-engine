...
Route::prefix(LaravelLocalization::setLocale())
    ...
    ->group(function () {
        ...
        Route::name('post.')->prefix(fs_db_config('website_post_path'))->group(function () {
            ...
            Route::get('location/{encoded}', [PostController::class, 'location'])->name('location')->withoutMiddleware([AccountAuthorize::class, UserAuthorize::class]);
        ...
        Route::name('comment.')->prefix(fs_db_config('website_comment_path'))->group(function () {
            ...
            Route::get('location/{encoded}', [CommentController::class, 'location'])->name('location')->withoutMiddleware([AccountAuthorize::class, UserAuthorize::class]);
